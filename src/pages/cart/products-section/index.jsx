...
const ProductsInCartSection = ( { summaryModal } ) => {

    const { size } = myContext()
  
    return (
        <div className={`flex flex-col items-start justify-start h-full w-full py-4 px-6  border rounded-sm shadow-sm mt-4 mb-40 ${summaryModal && size > 400 && 'mb-24'}`}>
            <header className='flex items-start justify-between w-full gap-2'>
                ...
                <section className='flex items-center max-[550px]:gap-0 gap-2 border  p-1 border-red-500 rounded-sm cursor-pointer'>
            ...
            <section className='mt-6 w-full'>
                ...
                <main className='border-t border-neutral-200/70 w-full flex flex-col'>

                    <div className='mt-2 flex items-start gap-4 max-[450px]:flex-col max-[450px]:items-center max-[450px]:justify-center'>
                        ...
                        <div className='flex-1  flex flex-col'>
                            ...
                            <h1 className='font-semibold text-sm max-md:leading-4 max-[450px]:text-center'>{textLimit( 'Mouse Sem Fio Gamer Logitech G PRO X Superlight, Lightspeed, 25000 DPI, 5 Botões, Preto - 910-005879',55 )}</h1>
                            <h2 className='text-sm pt-2 text-neutral-500 leading-3 max-md:text-xs max-[450px]:text-center'>Com desconto no PIX: <span className='font-bold'>R$ 749,99</span></h2>
                            <h2 className='text-sm text-neutral-500 leading-3 max-md:text-xs max-[450px]:text-center'>Parcelado no cartão em até 10x sem juros:<span className='font-bold'>R$ 882,34</span></h2>
                        ...
                        <div className='h-full flex-wrap max-md:flex-wrap max-md:flex-col max-md:justify-center  w-[300px] max-[1150px]:w-fit flex items-start justify-between '>
                            ...
                            <section className='flex flex-col items-center'>
                                ...
                                <p className='font-bold text-orange-500 text-end mt-3 max-sm:mt-1'>R$ 749,99</p>
                            </section>
