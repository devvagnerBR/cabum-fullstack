...
const Favorites = () => {
    ...
    const { productsAsFavorites,getProductDetails,addProductToCart,size } = myContext()
                                ...
                                <section className=' flex  gap-4 max-lg:w-full  border-l flex-col justify-center  pl-4  h-full  items-ce'>
                                    ...
                                    <div className='flex flex-col gap-0 items-start '>
                                        <div className='flex items-center w-full justify-between'>
                                            ...
                                            <Heart className='flex   fill-red-500 rounded-md hover:fill-red-400 cursor-pointer hover:shadow-sm' weight='fill' size={26} />
                                        </div>
                                        <h1
