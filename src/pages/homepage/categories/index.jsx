...
const Categories = () => {
    ...
    const categories = [
        ...
        { id: 4,name: 'COMPUTADORES',image_url: 'https://images.kabum.com.br/produtos/fotos/369923/notebook-asus-intel-core-i3-1005g1-4gb-ram-256gb-ssd-tela-15-6-endless-os-cinza-x515ja-br2750_1660313491_gg.jpg' },
        { id: 5,name: 'TV',image_url: 'https://images.kabum.com.br/produtos/fotos/154974/smart-tv-samsung-43-polegadas-uhd-4k-3-hdmi-1-usb-processador-crystal-4k-tela-sem-limites-alexa-controle-unico-un43au7700gxzd_1667248886_gg.jpg' },
        { id: 6,name: 'CELULAR & SMARTPHONE',image_url: 'https://images.kabum.com.br/produtos/fotos/324826/smartphone-samsung-galaxy-a23-4gb-ram-128gb-octa-core-camera-quadrupla-50mp-tela-infinita-6-6-azul-sm-a235mlbrzto_1648829309_gg.jpg' },
    ]
    ...
    return (
        <div
            ...
            <section
                className='w-full grid grid-cols-4  max-lg:grid-cols-3   gap-4 place-items-center  max-sm:w-[85vw] max-[390px]:grid-cols-2    p-2 bg-white '>
                ...
                {categories?.map( ( category ) => {
                    return (
                        <div key={category.id} className='bg-white w-[20vw] max-lg:w-[28vw]  h-fit flex p-2 flex-col items-center pb-4 rounded  cursor-pointer'>
