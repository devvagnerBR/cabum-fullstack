...
const PersonalData = ( { user,addressInfos } ) => {
    ...
    return (
        <div className='border p-4 rounded-sm'>
            ...
            <section className='pt-8 flex max-md:flex-col'>
                <section className='flex flex-col w-full'>
                    <header className='flex flex-col border-b pb-2'>
                        <p className='text-xl capitalize font-bold'>dados pessoais</p>
                        <p className='text-sm font-light text-neutral-400'>Informações que serão inseridas na nota fiscal do pedido.</p>
                    </header>
                ...
                <section className='w-full'>
                    <header className='flex flex-col border-b pb-2'>
                        ...
                        <p className='text-sm font-light text-neutral-400'>Este é o endereço onde seu pedido será enviado</p>
                    </header>

                    <aside className='pt-2 text-sm gap-1 flex flex-col'>
                        <p className='font-bold text-neutral-700 flex gap-2'>{addressInfos?.street}</p>
                        <p className='font-bold text-neutral-600 flex gap-2'>Bairro: <span className='font-normal'>
